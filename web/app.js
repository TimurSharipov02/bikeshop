...
const BLOCK_ICONS = {
  ...
  // Каретка — шатун без педали: ось каретки и рычаг.
  BB: '<path d="M9.47 4.53 19.41 16.59A2 2 0 0 1 16.59 19.41L4.53 9.47A3.5 3.5 0 0 1 9.47 4.53z"/><circle cx="7" cy="7" r="1.5"/><circle cx="18" cy="18" r=".6"/>',
  ...
  // Трансмиссия — звено цепи.
  DRV: '<path d="M6.5 7.5Q12 10 17.5 7.5A4.5 4.5 0 0 1 17.5 16.5Q12 14 6.5 16.5A4.5 4.5 0 0 1 6.5 7.5z"/><circle cx="6.5" cy="12" r="1.7"/><circle cx="17.5" cy="12" r="1.7"/>',
